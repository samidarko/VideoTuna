...
from src.opensora_v12.acceleration.checkpoint import auto_grad_checkpoint
from src.opensora_v12.acceleration.communications import gather_forward_split_backward, split_forward_gather_backward
from src.opensora_v12.acceleration.parallel_states import get_sequence_parallel_group
from src.opensora_v12.models.layers.blocks import (
    Attention,
    CaptionEmbedder,
...
from src.opensora_v12.registry import MODELS
from src.opensora_v12.utils.ckpt_utils import load_checkpoint
...
class STDiTBlock2(nn.Module):
    ...
    def forward(self, x, y, tpe, t, t_tmp, mask=None, x_mask=None, t0=None, t0_tmp=None, T=None, S=None):
        B, N, C = x.shape
