...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, validation=None, test=None, predict=None,
                 ...
                 shuffle_val_dataloader=False, img_loader=None, train_img=None, 
        ...
        if train_img is not None:
            if train_img["params"]["batch_size"] == -1:
                train_img["params"]['batch_size'] = batch_size * train['params']['video_length']
                print("Set train_img batch_size to {}".format(train_img["params"]['batch_size']))
