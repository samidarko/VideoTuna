from src.third_party.flux.data_backend.local import LocalDataBackend
from src.third_party.flux.data_backend.aws import S3DataBackend
from src.third_party.flux.data_backend.csv_url_list import CSVDataBackend
from src.third_party.flux.data_backend.base import BaseDataBackend
from src.third_party.flux.training.default_settings import default, latest_config_version
from src.third_party.flux.caching.text_embeds import TextEmbeddingCache

from src.third_party.flux.training.exceptions import MultiDatasetExhausted
from src.third_party.flux.multiaspect.dataset import MultiAspectDataset
from src.third_party.flux.multiaspect.sampler import MultiAspectSampler
from src.third_party.flux.prompts import PromptHandler
from src.third_party.flux.caching.vae import VAECache
from src.third_party.flux.training.multi_process import should_log, rank_info, _get_rank as get_rank
from src.third_party.flux.training.collate import collate_fn
...
def configure_multi_databackend(args: dict, accelerator, text_encoders, tokenizers):
    ...
    for backend in data_backend_config:
        ...
        if metadata_backend == "json" or metadata_backend == "discovery":
            from src.third_party.flux.metadata.backends.discovery import DiscoveryMetadataBackend

            BucketManager_cls = DiscoveryMetadataBackend
        elif metadata_backend == "parquet":
            from src.third_party.flux.metadata.backends.parquet import ParquetMetadataBackend
