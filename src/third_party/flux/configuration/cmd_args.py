...
import sys
import torch
from src.third_party.flux.models.smoldit import SmolDiTConfigurationNames
from src.third_party.flux.training import quantised_precision_levels
...
def parse_cmdline_args(input_args=None):
    ...
    from src.third_party.flux.training.optimizer_param import optimizer_parameters
