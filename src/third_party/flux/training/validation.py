...
from src.third_party.flux.models.sdxl.pipeline import (
...
from src.third_party.flux.multiaspect.image import MultiaspectImage
from src.third_party.flux.image_manipulation.brightness import calculate_luminance
...
try:
    from src.third_party.flux.models.sd3.pipeline import (
...
def prepare_validation_prompt_list(args, embed_cache):
    ...
    if args.validation_prompt_library:
        ...
        from src.third_party.flux.prompts import prompts as prompt_library
...
class Validation:
    ...
    def _pipeline_cls(self):
        ...
        if model_type == "sdxl":
            ...
            from src.third_party.flux.models.flux import FluxPipeline
            ...
            from src.third_party.flux.models.pixart.pipeline import PixArtSigmaPipeline

            return PixArtSigmaPipeline
        elif model_type == "smoldit":
            from src.third_party.flux.models.smoldit import SmolDiTPipeline
