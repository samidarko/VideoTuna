...
def get_lr_scheduler(
    ...
    if use_deepspeed_scheduler:
        ...
        from src.third_party.flux.training.custom_schedule import CosineAnnealingHardRestarts
        ...
        from src.third_party.flux.training.custom_schedule import Sine
        ...
        from src.third_party.flux.training.custom_schedule import Cosine
