...
from src.third_party.flux.models.smoldit import SmolDiT2DModel, SmolDiTPipeline
import os
import logging
import shutil
import json
...
class SaveHookManager:
    def __init__(
        ...
        if self.unet is not None:
            ...
            if args.model_family == "sd3":
                ...
                from src.third_party.flux.models.flux.transformer import (
    ...
    def _save_lycoris(self, models, weights, output_dir):
        ...
        via lycoris.
        """
        from src.third_party.flux.publishing.huggingface import LORA_SAFETENSORS_FILENAME
