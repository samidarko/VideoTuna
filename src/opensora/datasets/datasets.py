...
class DatasetFromCSV(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if 'panda2m' in self.csv_path:
            safe_data_path = '/project/llmsvgen/share/opensora_datafile/panda2m_safe.csv'
        elif 'webvid' in self.csv_path:
            safe_data_path = '/project/llmsvgen/share/opensora_datafile/webvid_safe.csv'
...
class DatasetFromMultiCSV(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.csv_path = {
            ...
            'panda2m': '/project/llmsvgen/share/opensora_datafile/panda2m.csv',
            'vript': '/project/llmsvgen/share/data_yazhou/lzy/vript.csv'
        }

        self.safe_data_list = []
        self.data_list = []
        for dataset in ['webvid', 'vript', 'panda2m']:
            ...
            if dataset == 'panda2m':
                ...
                safe_data_path = '/project/llmsvgen/share/opensora_datafile/vript_safe.csv'
