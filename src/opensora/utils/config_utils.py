...
def parse_args(training=False):
    ...
    parser.add_argument("--outputs", default="outputs", type=str, help="batch size")
    ...
    if not training:
        ...
        parser.add_argument("--infer_num", default=30, type=int, help="number of samples to generate")
        ...
        parser.add_argument("--wandb", default=True, type=bool, help="enable wandb")
        parser.add_argument("--load", default=None, type=str, help="path to continue training")
        parser.add_argument("--data-path", default=None, type=str, help="path to data csv")
        parser.add_argument("--remarks", default=None, type=str)
...
def create_experiment_workspace(cfg):
    ...
    if not cfg.remarks is None:
        exp_name = f"{experiment_index:03d}-F{cfg.num_frames}S{cfg.frame_interval}-{model_name}-{cfg.remarks}"
    else:
