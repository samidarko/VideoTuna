...
image_files = [f for f in os.listdir(args.input_dir) if f.endswith('.jpg') or f.endswith('.png')]
...
if num_of_images != 0:
    assert num_of_prompts == num_of_images, 'The number of prompts should be equal to the number of images'
else:
