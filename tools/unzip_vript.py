...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='./Vript/vript_short_videos_clips_unzip')
    parser.add_argument('--zip_folder', type=str, default='./Vript/vript_short_videos_clips')
