...
docker compose run --remove-orphans videotuna poetry run pip install chumpy==0.70 --no-build-isolation
docker compose run --remove-orphans videotuna poetry run pip install torch==2.2.2
docker compose run --remove-orphans videotuna poetry run pip install torch-scatter==2.1.2 --no-build-isolation
