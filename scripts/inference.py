    ...
    with torch.no_grad():
        for idx in trange(0, n_iters, desc="Sample Iters"):
            ...
            if args.mode == 't2v':
                ...
                batch_samples = sample_batch_i2v(model, ddim_sampler, prompts, images, noise_shape, 
                                        args.n_samples_prompt, args.ddim_steps, args.ddim_eta, 
                                        args.unconditional_guidance_scale, args.cfg_img, 
                                        args.fps, args.uncond_prompt, args.multiple_cond_cfg, 
                                        args.loop, args.gfi, args.timestep_spacing, args.guidance_rescale
                                        )
            else:
                raise ValueError
